...
router.get('/hari-libur', requireOperator, (req,res) => res.sendFile(path.join(VIEWS,'hari_libur.html')));
router.get('/broadcast',  requireOperator, (req,res) => res.sendFile(path.join(VIEWS,'broadcast.html')));
